...
public enum DMNMessageType {
    ...
    CONTEXT_DUP_ENTRY( "", Tag.DMN_VALIDATOR ),
    CONTEXT_ENTRY_NOTYPEREF ( "", Tag.DMN_VALIDATOR ),
    ...
    NAME_INVALID( "", Tag.DMN_VALIDATOR ),                           // DUPS of INVALID_NAME ?
    ...
    TYPEREF_NOT_FEEL_NOT_DEF( "", Tag.DMN_VALIDATOR )                // DUPS of TYPE_DEF_NOT_FOUND ?
    ;
