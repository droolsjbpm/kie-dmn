...
public class ValidatorTest {
    ...
    public void testBKM_MISSING_EXPR() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.BKM_MISSING_EXPR ) ) );
    }
    ...
    public void testBKM_MISSING_VAR() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.BKM_MISSING_VAR ) ) );
    }
    ...
    public void testCONTEXT_DUP_ENTRY() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.CONTEXT_DUP_ENTRY ) ) );
    }
    ...
    public void testCONTEXT_ENTRY_NOTYPEREF() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.CONTEXT_ENTRY_NOTYPEREF ) ) );
    }
    ...
    public void testDECISION_MISSING_EXPR() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DECISION_MISSING_EXPR ) ) );
    }
    ...
    public void testDECISION_MISSING_VAR() {
        ...
        assertEquals(1, validate.stream().filter( p -> p.getMessageId().equals( DMNMessageTypeId.DECISION_MISSING_VAR )).count() );
        
        DMNMessage msg0 = validate.stream().filter( p -> p.getMessageId().equals( DMNMessageTypeId.DECISION_MISSING_VAR )).findFirst().get();
        assertEquals(DMNMessageTypeId.DECISION_MISSING_VAR, msg0.getMessageId());
    ...
    public void testDECISION_MISSING_VARbis() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DECISION_MISSING_VAR ) ) );
    }
    ...
    public void testDRGELEM_NOT_UNIQUE() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DRGELEM_NOT_UNIQUE ) ) );
    }
    ...
    public void testDTABLE_MULTIPLEOUT_NAME() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DTABLE_MULTIPLEOUT_NAME ) ) );
    }
    ...
    public void testDTABLE_MULTIPLEOUT_TYPEREF() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DTABLE_MULTIPLEOUT_TYPEREF ) ) );
    }
    ...
    public void testDTABLE_PRIORITY_MISSING_OUTVALS() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DTABLE_PRIORITY_MISSING_OUTVALS ) ) );
    }
    ...
    public void testDTABLE_SINGLEOUT_NONAME() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DTABLE_SINGLEOUT_NONAME ) ) );
    }
    ...
    public void testDTABLE_SINGLEOUT_NOTYPEREF() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.DTABLE_SINGLEOUT_NOTYPEREF ) ) );
    }
    ...
    public void testELEMREF_MISSING_TARGET() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.ELEMREF_MISSING_TARGET ) ) );
    }
    ...
    public void testELEMREF_NOHASH() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.ELEMREF_NOHASH ) ) );
    }
    ...
    public void testFORMAL_PARAM_DUPLICATED() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.FORMAL_PARAM_DUPLICATED ) ) );
    }
    ...
    public void testINPUTDATA_MISSING_VAR() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.INPUTDATA_MISSING_VAR ) ) );
    }
    ...
    public void testINVOCATION_INCONSISTENT_PARAM_NAMES() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.INVOCATION_INCONSISTENT_PARAM_NAMES ) ) );
    }
    ...
    public void testINVOCATION_MISSING_TARGET() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.INVOCATION_MISSING_TARGET ) ) );
    }
    ...
    public void testINVOCATION_WRONG_PARAM_COUNT() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.INVOCATION_WRONG_PARAM_COUNT ) ) );
    }
    ...
    public void testITEMCOMP_DUPLICATED() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.ITEMCOMP_DUPLICATED ) ) );
    }
    ...
    public void testITEMDEF_NOT_UNIQUE() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.ITEMDEF_NOT_UNIQUE ) ) );
    }
    ...
    public void testITEMDEF_NOT_UNIQUE_DROOLS_1450() {
        ...
        assertFalse( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.ITEMDEF_NOT_UNIQUE ) ) );
    }
    ...
    public void testNAME_INVALID() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.NAME_INVALID ) ) );
    }
    ...
    public void testNAME_INVALID_bis() {
         ...
         */
        assertEquals("functional optimization of valid names to report ", 1, validate.stream().filter( p -> p.getMessageId().equals( DMNMessageTypeId.NAME_INVALID ) ).count() );
    }
    ...
    public void testRELATION_DUP_COLUMN() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.RELATION_DUP_COLUMN ) ) );
    }
    ...
    public void testRELATION_ROW_CELL_NOTLITERAL() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.RELATION_ROW_CELL_NOTLITERAL ) ) );
    }
    ...
    public void testRELATION_ROW_CELLCOUNTMISMATCH() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.RELATION_ROW_CELLCOUNTMISMATCH ) ) );
    }
    ...
    public void testREQAUTH_NOT_KNOWLEDGESOURCE() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.REQAUTH_NOT_KNOWLEDGESOURCE ) ) );
    }
    ...
    public void testTYPEREF_NO_FEEL_TYPE() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.TYPEREF_NO_FEEL_TYPE ) ) );
    }
    ...
    public void testTYPEREF_NOT_FEEL_NOT_DEF() {
        ...
        assertTrue( validate.stream().anyMatch( p -> p.getMessageId().equals( DMNMessageTypeId.TYPEREF_NOT_FEEL_NOT_DEF ) ) );
    }
    ...
    public void testTYPEREF_NOT_FEEL_NOT_DEF_valid() {
        ...
        assertTrue( validate.stream().noneMatch( p -> p.getMessageId().equals( DMNMessageTypeId.TYPEREF_NOT_FEEL_NOT_DEF ) ) );
    }
